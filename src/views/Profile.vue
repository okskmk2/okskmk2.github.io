  ...
  <div>
    ...
    <section>
      ...
      <article>
        ...
        <h4><i class="fa fa-calendar fa-fw mr5"></i>2021-2 ~</h4>
      ...
      <article>
        <h3>LG전자 냉장고 매장앱 접근성 보안 퍼블리싱</h3>
        <h4><i class="fa fa-calendar fa-fw mr5"></i>2021-11 ~ 2021-12</h4>
        <p>키보드 조작 지원, 시맨틱 태그로 교체작업, 사용성 강화를 위한 UI 재정비 작업</p>
        <p>기술스택 : vuejs, sass</p>
        <p></p>
        <p>역할 : 퍼블리싱</p>
      </article>
      <article>
        <h3>LG전자 담다 프로젝트</h3>
        <h4><i class="fa fa-calendar fa-fw mr5"></i>2021-9 ~ 2021-10</h4>
      ...
      <article>
        ...
        <h4><i class="fa fa-calendar fa-fw mr5"></i>2020-12 ~ 2021-2</h4>
      ...
      <article>
        ...
        <h4><i class="fa fa-calendar fa-fw mr5"></i>2020-06 ~ 2020-12</h4>
    ...
    <section>
      ...
      <article>
        <h3>웹기획 고급과정</h3>
        <h4>
          <i class="fa fa-calendar fa-fw mr5"></i>2018-12
        </h4>
        <p>기획, 사용자조사, UI/UX기획, 제안서, 견적서 작성법, 프로젝트 관리 실무과정</p>
      </article>
      <article>
        <h3>Angular 5 개발과정</h3>
        <h4>
          <i class="fa fa-calendar fa-fw mr5"></i>2018-04
        </h4>
        <p>Angular 5 프론트엔드개발 32시간 수료</p>
      </article>
      <article>
        <h3>한국인터넷 진흥원 핀테크 서비스개발</h3>
        <h4>
          <i class="fa fa-calendar fa-fw mr5"></i>2017-07
        </h4>
        <p>핀테크 웹서비스 개발 사례연구 및 프로젝트 리딩</p>
      </article>
      <article>
      ...
      <article>
        <h3>정보처리산업기사</h3>
        <h4>
          <i class="fa fa-calendar fa-fw mr5"></i>2016-04
        </h4>
        <p>주요 내용 : 알고리즘, 데이터베이스 구조, 네트워크 보안</p>
      </article>
      <article>
        <h3>중앙처리컴퓨터학원</h3>
        <h4>
          <i class="fa fa-calendar fa-fw mr5"></i>2015-10 ~ 2016-04
        </h4>
        <p>수석 수료</p>
